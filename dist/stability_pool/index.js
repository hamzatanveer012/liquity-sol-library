    ...
    constructor() {
        ...
        this.createPool = (owner, owner_token_account, amount) => __awaiter(this, void 0, void 0, function* () {
            ...
            models_1.StabilityPoolModel.encode({
                pool_provider: new web3_js_1.PublicKey(owner).toBuffer(),
                pool_amt: BigInt(amount),
                open: true,
            }, data);
            let new_acc = web3_js_1.Keypair.generate();
            const transaction = new web3_js_1.Transaction().add(web3_js_1.SystemProgram.createAccount({
                ...
                keys: [
                    ...
                    { pubkey: new_acc.publicKey, isSigner: true, isWritable: true },
                    { pubkey: owner_token_account, isSigner: false, isWritable: true },
                    { pubkey: constants_1.POOL_PROGRAM_TOKEN_ACC, isSigner: false, isWritable: true },
                    { pubkey: constants_1.MINT, isSigner: false, isWritable: true },
                    { pubkey: constants_1.MINT_AUTHORITY, isSigner: false, isWritable: false },
                    { pubkey: web3_js_1.SystemProgram.programId, isSigner: false, isWritable: false },
                    { pubkey: spl_token_1.TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
                    { pubkey: constants_1.TROVE_PROGRAM_ID, isSigner: false, isWritable: false },
                ],
